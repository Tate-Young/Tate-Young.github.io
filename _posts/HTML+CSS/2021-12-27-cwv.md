...
update: 2022-01-11 19:35:00 GMT+0800 (CST)
description: add critical rendering path and long task
...
1. 关键路径长度 - 获取所有关键资源所需的往返次数或总时间
1. 关键字节 - 实现网页首次渲染所需的总字节数，它是所有关键资源传送文件大小的总和。如压缩
