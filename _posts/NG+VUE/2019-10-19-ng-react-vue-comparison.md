...
2. 他们分别有什么特性？
3. AngularJS 和 Angular 有什么区别吗？Vue 是抄袭 AngularJS 吗？
4. 他们在未来的发展趋势是什么
5. 我应该选择哪一个
6. 我学不动了怎么办
...
在讲 Angular 之前，必须要提到它的前身 **AngularJS**，作为老大哥，他 2009 年就出道了，它的背后就是 Google 大佬，因此它的出世必定受到世人的瞩目，那么它的出现给我们带来了什么:
...
* 提供 Angular CLI 脚手架
* 提供了更全面的生命周期钩子
* 提升移动端的性能和 `iconic` 的融合，提供 `@angular/service-worker` 组件，更易于实践 PWA
* 抛弃传统的 controller + $scope 的设计，拥抱组件式开发
* 融合 RxJS - 创建可观察对象，提供一系列操作符，替代 Promise，具体[参考我的这篇博客]( {{site.url}}/2018/03/21/es6-promise-observable.html )
* 修改脏检测机制，采用单向数据流
* 性能更好，体积更小
...
* 万物皆 JavaScript - JSX、[CSS In Js](2019/04/13/css-in-js.html)
...
> Vue 介绍可以[参考我的这篇博客]( {{site.url}}/2018/08/06/react-react-router.html ) 👈
...
我们可以看到 Angular 和 React 在国际上使用还是很多的，而且发展趋于稳定。而 Vue 的话近几年发展速度很快，在国内已经达到很高的占有率，相比之下它的发展目前并不稳定。
...
4. [Angular vs React vs Vue: Which is the Best Choice for 2019?](https://hackernoon.com/angular-vs-react-vs-vue-which-is-the-best-choice-for-2019-16ce0deb3847) By Sophia
5. [React vs Angular vs Vue.js — What to choose in 2019?](https://medium.com/@TechMagic/reactjs-vs-angular5-vs-vue-js-what-to-choose-in-2018-b91e028fa91d) By TechMagic
