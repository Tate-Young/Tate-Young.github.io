...
我们可以看到 Angular 和 React 在国际上使用还是很多的，而且发展趋于稳定，社区也比较强大。而 Vue 的话近几年发展速度很快，在国内已经达到很高的占有率，相比之下它的发展目前并不稳定。
...
通过状态管理容器可以更方便管理数据和追踪变更，更容易维护和侦错:
...
现代框架之间的差距日渐减少，在选型方面不用太过纠结，可以参考下:
...
6. [2019 年，Flutter 和 React Native 谁主沉浮](https://juejin.im/post/5d018eb8e51d4550723b13d9) By 前端小智
