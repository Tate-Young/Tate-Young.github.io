...
background-image: /style/images/smms/webAuthn-flow-1.webp
tags:
- docker
---
# {{ page.title }}
...
![flow-1]( {{site.url}}/style/images/smms/webAuthn-flow-1.webp )
...
![flow-2]( {{site.url}}/style/images/smms/webAuthn-flow-2.webp )
