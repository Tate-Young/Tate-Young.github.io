...
想当年最开始工作的时候，就是做的移动端 hybrid 混合式开发，里面很重要的一环就是 JS 与原生 Native 的相互通信，而它就是我们今天要介绍的主人翁 - **JSBridge**。顾名思义，它作为一座桥梁，连接了 JS 与 Native，让前端可以方便地调用原生的摄像头、视频等，而原生也可以接收前端发出的信息而作出相应的处理。准确来讲，它并不是一项技术，而是一套解决方案。在介绍 JSBridge 原理之前，我们先看看传统方式是怎么来使用的。以下主要[摘自 JSBridge 深度剖析这篇博客](https://blog.csdn.net/xiangzhihong8/article/details/66970600):
...
![whole period](https://yqfile.alicdn.com/1dda1826cc58c69285e46c138ea54245cfe3b66c.png)
